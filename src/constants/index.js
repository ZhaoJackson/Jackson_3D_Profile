import {
  ...
  const research = [
    ...
    {
        title: "Benchmarking AI Text Generation for Equity in Social Work: A Framework for Ethical and Inclusive Evaluation",
        status: "In Progress",
    ...
    {
      title: "Don't Treat AI Chatbots like a Google Search: An Introduction to Prompt Engineering for Social Workers",
      status: "Under Review",
    ...
    {
      title: "A Scoping Review on the Application of Artificial Intelligence (AI) and Large Language Models (LLMs) in LGBTQ+ Health: Implications for Social Work Practice and Research",
      status: "Under Review",
